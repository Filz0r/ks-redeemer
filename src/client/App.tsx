...
export default function App() {
	...
	const processUsers = useCallback(
		async (userIdList: string[], code: string) => {
			...
			setProgress({ current: 0, total: userIdList.length, success: 0, failed: 0 });
	...
	return (
		<div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 p-8 lg:p-12">
